...
const AuditLogs = () => {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto p-6">
      ...
      >
        {/* HEADER */}
        <div className="px-6 py-6 border-b border-[#F1F5F9] flex items-center justify-between">
          <div>
            <h2
          ...
          <div className="flex items-center gap-3">
            <button
              style={{ fontFamily: "GeneralSans" }}
              className="h-[40px] px-5 rounded-[14px] border border-[#94A3B8] flex items-center gap-2 text-[14px] font-medium text-[#475569] hover:bg-[#F8FAFC] transition-all"
            >
              <FiDownload size={16} />
              Export CSV
            </button>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              ...
              >
                <th className="px-6 text-left text-[12px] font-bold uppercase tracking-[0.6px] text-[#62748E]">
                  Event
                </th>
            ...
            <tbody>
              {filteredLogs.map((log, index) => (
                ...
                >
                  <td className="px-6">{getBadge(log.event)}</td>
                  ...
                  <td className="px-6 text-[14px] text-[#334155]">
                    {log.details}
                  </td>

                  <td className="px-6 text-[14px] text-[#94A3B8]">{log.ip}</td>

                  <td className="px-6 text-[14px] text-[#475569]">
                    {log.timestamp}
                  </td>
                </tr>
              ))}
