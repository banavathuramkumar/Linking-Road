  ...
  return (
    <section className="w-full bg-white border-y border-[#E2E8F0] px-4 sm:px-6 lg:px-[102px] py-[96px] overflow-hidden">
      ...
      <div className="max-w-[1442px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-24">
          ...
          <div className="mt-10 flex flex-col gap-6">
            {features.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                {/* ICON */}
                <div className="w-6 h-6 rounded-full border border-[#7C3AED] flex items-center justify-center shrink-0">
        ...
        {/* RIGHT CHAT UI */}
        <div className="w-full max-w-[620px] rounded-[24px] border border-[#E2E8F0] bg-white overflow-hidden shadow-[0px_25px_50px_-12px_rgba(15,23,42,0.12)]">
          {/* TOP BAR */}
          ...
          <div className="flex h-[540px]">
            ...
            <div className="flex-1 flex flex-col justify-between bg-white">
              ...
              <div className="p-5 sm:p-6">
                ...
                {/* AI REPLY */}
                <div className="mt-8 flex items-start justify-end gap-4">
                  {/* MESSAGE */}
              ...
              <div className="p-5 sm:p-6 border-t border-[#F1F5F9]">
                <div className="w-full h-[56px] rounded-full border border-[#E2E8F0] bg-[#F8FAFC] px-5 flex items-center">
                  <p
                    style={{ fontFamily: "Inter" }}
